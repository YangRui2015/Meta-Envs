...
from meta_envs.rand_param_envs.gym import spaces
from meta_envs.rand_param_envs.gym.envs.box2d.car_dynamics import Car
from meta_envs.rand_param_envs.gym.utils import colorize, seeding
...
class CarRacing(gym.Env):
    ...
    def _render(self, mode='human', close=False):
        ...
        if self.viewer is None:
            from meta_envs.rand_param_envs.gym.envs.classic_control import rendering
